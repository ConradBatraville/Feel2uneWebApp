      ...
      <div>
        ...
        >
          <div className="nav-left">
            <a
              href="https://www.linkedin.com/in/conradbatraville/"
              className="nav-item"
            >
              <span className="icon">
        ...
        {this.state.user.name ? (
          <div>
            ...
            <TrackView
              ...
              playlist={this.props.selectedTrack}
            />
          </div>
        ) : (
          <div>
            <div>
              <img
                className="logo"
                src="https://i.ibb.co/wJb3z3Y/Feel2une-Logo.jpg"
                alt="Feel2une-Logo"
              />
            </div>
            <div
